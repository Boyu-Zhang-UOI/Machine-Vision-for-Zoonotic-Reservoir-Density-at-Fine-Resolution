...
p = ggplot(cor_models[constraints == "Spatial" & house_name == 'All',],
    ...
    xlab('Model type')
p
ggsave(paste0(model.path, 'Compare_wtcor_models.png'), width = 8, height = 5)
...
out = ggplot(ranked[Model_Type!='TS' & house_name=='All' &
    ...
    xlab('Model type')
out
ggsave(paste0(model.path, 'Compare_models.png'), width = 8, height = 5)
...
out
ggsave(paste0(model.path, 'Compare_house.png'), width = 8, height = 4)
...
out
ggsave(paste0(model.path, 'Compare_precip.png'), width = 8, height = 4)
...
out
ggsave(paste0(model.path, 'Compare_visit.png'), width = 8, height = 4)
...
## out$labels$colour = 'Model type'
## out
## ggsave(paste0(model.path,'Ranking_curves.png'))
